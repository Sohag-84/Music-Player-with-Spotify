...
import 'package:spotify_music_player/constant/config.dart';
...
class _MusicPlayerState extends State<MusicPlayer> {
  ...
  Music music = Music(trackId: '6rWblGW0pBcB3uygxBuWZV');
  ...
  void initState() {
    final credentials =
        SpotifyApiCredentials(AppConfig.clientId, AppConfig.clientSecret);
